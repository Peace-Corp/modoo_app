  ...
  try {
    ...
    if (adminEmail) {
      sendGmailEmail({
        ...
        subject: `[수정 요청] ${customerName} - ${itemLabel} (${shortOrderId})`,
        ...
        html: `
          <div style="font-family:'Apple SD Gothic Neo','Malgun Gothic',sans-serif;max-width:600px;margin:0 auto;background:#ffffff;">
            <div style="text-align:center;padding:24px 0;background:#fffbeb;">
              <img src="https://modoouniform.com/icons/modoo_logo.png" alt="모두의 유니폼" style="height:48px;" />
            </div>
            <div style="height:3px;background:#d97706;"></div>
            <div style="padding:32px 28px;">
              <div style="text-align:center;margin-bottom:24px;">
                <div style="display:inline-block;background:#d97706;color:#fff;padding:8px 20px;border-radius:20px;font-size:14px;font-weight:600;">수정 요청</div>
              </div>
              ...
              <div style="background:#fffbeb;border-left:3px solid #d97706;padding:16px;border-radius:0 8px 8px 0;margin:20px 0;">
                <p style="margin:0 0 4px;font-size:12px;color:#92400e;font-weight:600;">고객 수정 요청 내용</p>
                <p style="margin:0;font-size:15px;color:#1a1a1a;line-height:1.6;white-space:pre-wrap;">${revisionNote.trim()}</p>
              </div>
              <div style="text-align:center;margin:28px 0;">
                <a href="${adminUrl}" style="display:inline-block;padding:14px 32px;background-color:#d97706;color:#ffffff;border-radius:10px;font-weight:bold;font-size:14px;text-decoration:none;">관리자 페이지에서 확인</a>
              </div>
            </div>
          </div>
        `,
