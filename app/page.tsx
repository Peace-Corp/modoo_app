...
export default function Home() {
  ...
  useEffect(() => {
    // On web, redirect to /home after splash screen
    // On mobile, stay here and load the home page content
    if (!isNative()) {
      setTimeout(() => {
        router.push('/home');
      }, 1000);
    } else {
      // On mobile, load products client-side
      loadProducts();
    }
  }, [router]);
  ...
  // Show loading spinner for web (during redirect) or mobile (while loading)
  if (!isNative() || loading) {
