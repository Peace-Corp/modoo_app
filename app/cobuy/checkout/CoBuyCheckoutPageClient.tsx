...
interface CoBuyCheckoutPageClientProps {
  sessionId: string;
}

export default function CoBuyCheckoutPageClient({ sessionId }: CoBuyCheckoutPageClientProps) {
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-3xl mx-auto p-6 text-center">
          ...
          <button
            onClick={() => router.push(routes.cobuyMyPageDetail(sessionId))}
