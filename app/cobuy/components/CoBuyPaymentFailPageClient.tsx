...
interface CoBuyPaymentFailContentProps {
  shareToken: string;
}

function CoBuyPaymentFailContent({ shareToken }: CoBuyPaymentFailContentProps) {
  ...
  useEffect(() => {
    const deleteParticipant = async () => {
      try {
        ...
        await api.cobuy.deleteParticipant({
...
interface CoBuyPaymentFailPageClientProps {
  shareToken: string;
}

export default function CoBuyPaymentFailPageClient({ shareToken }: CoBuyPaymentFailPageClientProps) {
  return (
    <Suspense fallback={
      ...
      <CoBuyPaymentFailContent shareToken={shareToken} />
    </Suspense>
  );
}
